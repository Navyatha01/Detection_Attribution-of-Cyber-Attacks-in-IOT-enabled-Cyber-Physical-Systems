...
ting model will take 100 iterations            
    ...
    if os.path.exists("model/encoder_model.json"):
        ...
        autoencoder.save_weights('model/encoder_model_weights.h5')#above line for crea
        json_file.close
